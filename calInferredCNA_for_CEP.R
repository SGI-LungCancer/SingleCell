calInferredCNV.NotNormal <- function(
  obj, min.cells = 10, MYwalk = 150, z.score = TRUE,  limit = TRUE,AnnotationLevel = "GRCh38", log.file = "log_files.txt",
  use.total = FALSE
  ){

  ##
  GTF_uniq <- readGTF.addData(AnnotationLevel)
